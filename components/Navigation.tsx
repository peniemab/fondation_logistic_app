    ...
    <nav className="bg-white border-b border-slate-200  sticky top-0 z-40 print:hidden shadow-sm">
      <div className="max-w-[1200px] mx-auto flex justify-between items-center">
        ...
        <div
          ...
          className="flex items-center gap-2 p-5 cursor-pointer group"
        >
        ...
        <div className="flex gap-2">
          <button
            onClick={() => setActiveView('hub')}
            className="text-xs font-black px-3 py-2 text-slate-500 hover:bg-slate-100 rounded-lg uppercase"
          >
            Menu Principal
          </button>
          <button
